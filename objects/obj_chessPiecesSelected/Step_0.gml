...
//Move piece
if (mouse_check_button_released(mb_left) and (instance_position(mouse_x, mouse_y, obj_highlight) or instance_position(mouse_x, mouse_y, obj_selected))) {
	if (instance_position(mouse_x, mouse_y, obj_highlight)) {
		...
		obj_chessPiecesSelected.x = initX * global.squareWidth
		obj_chessPiecesSelected.y = initY * global.squareWidth
		click_number += 1
	}
